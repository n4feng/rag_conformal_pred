...
def get_legend_name(confidence_method):
    if (
        ...
        return "Optimal"
    elif confidence_method == "similarity" or confidence_method == "similarity-ranking":
        return "Similarity"
...
def get_confidence(entry, method, openai_client, model):
    ...
    # This assumes frequency was already added.
        ...
        return [float(subclaim["similarity-score"]) for subclaim in entry["claims"]]
    elif method == "optimal":
        return [
